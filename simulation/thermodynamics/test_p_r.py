...
PVT.get_props(pvt,T,P)
# pvt=setPVT.get_props_and_equalize([(36,'methane'),(64,'octane')])
# pvt1=setPVT.get_props_and_equalize([(36,'methane')])
# pvt2=setPVT.get_props_and_equalize([(64,'benzene')])
# pvt3=setPVT.get_props_and_equalize([(36,'methane'),(64,'benzene'),(0.5,'oxygen')])
# print '>>>>>>>>>>>>>>>>>>>>'
# print [pvt3[i]['comp'] for i in pvt3]
# a=flash3.Flash(pvt3,T,P)
# a.equilibriate()
# print [pvt3[i]['comp'] for i in pvt3]
# print a.phases[0]['frac']
# b=peng_robinson.fug_minimum_gibbs(pvt1,T,P,1.,phase='heavy',returnV=True)
# print {i:exp(b[0][i]) for i in b[0]},b[1]*P/(8.314*(T+273.15))
# b=peng_robinson.fug_minimum_gibbs(pvt1,T,P,1.,phase='light',returnV=True)
# print {i:exp(b[0][i]) for i in b[0]},b[1]*P/(8.314*(T+273.15))
# b=peng_robinson.fug_minimum_gibbs(pvt2,T,P,1.,phase='heavy',returnV=True)
# print {i:exp(b[0][i]) for i in b[0]},b[1]*P/(8.314*(T+273.15))
# b=peng_robinson.fug_minimum_gibbs(pvt3,T,P,1.,comp={'methane':.0028,'benzene':.9972},phase='light',returnV=True)
# print {i:exp(b[0][i]) for i in b[0]},b[1]*P/(8.314*(T+273.15))
# b=peng_robinson.fug_minimum_gibbs(pvt3,T,P,1.,comp={'methane':.8652,'benzene':.1348},phase='heavy',returnV=True)
# print {i:exp(b[0][i]) for i in b[0]},b[1]*P/(8.314*(T+273.15))
# print '--------------------'
# b=peng_robinson.fug_minimum_gibbs(pvt3,T,P,1.,phase='heavy',returnV=True)
# print {i:exp(b[0][i]) for i in b[0]},b[1]*P/(8.314*(T+273.15))
# b=peng_robinson.fug_minimum_gibbs(pvt3,T,P,1.,phase='light',returnV=True)
# print {i:exp(b[0][i]) for i in b[0]},b[1]*P/(8.314*(T+273.15))
# print '<<<<<<<<<<<<<<<<<<<<'
...
y_3=[]
c_3=[]
for P in range(1,int(12226750.0),int(.5e5)):
